...
\begin{tikzpicture}[x=1cm,y=1cm,line join=round,line cap=round,
  ...
  \begin{scope}[shift={(\Q,0)}]
    \panlab{-0.15}{(b)}
    % --- mirror + odd displacement (upper) ---
    \draw[sec,line width=0.5pt,dashed,dash pattern=on 2pt off 1.6pt]
      (1.35,1.85) -- (1.35,2.85);
    \node[sec,font=\footnotesize,anchor=south] at (1.35,2.82) {mirror};
    % ghost (-delta) and real (+delta) Na
    \node[circle,draw=nadk,fill=na!35,line width=0.4pt,minimum size=5pt,
      inner sep=0pt] at (0.72,2.2) {};
    \node[circle,draw=nadk,fill=na,line width=0.4pt,minimum size=5pt,
      inner sep=0pt] at (1.98,2.2) {};
    \draw[sec,line width=0.5pt,{Latex[length=2.8pt]}-{Latex[length=2.8pt]}]
      (0.9,2.2) -- (1.8,2.2);
    \node[nadk,font=\footnotesize,anchor=north,inner sep=1.5pt] at (1.35,2.12)
      {$\delta$ (odd)};
    % --- two vertices (lower) ---
